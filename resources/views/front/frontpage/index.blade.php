@section('content')
@extends('layouts.frontapp', ['title' => 'Admisi'])
...
<div class="preloader">
    ...
    <div class="banner banner--one position-relative" id="home">
        <div class="shape">
            <div class="shape__item wow fadeInDown" data-wow-delay=".5s">
                <img src="assets/images/banner/shape/01.png" alt="rajibraj">
            </div>
            <div class="shape__item wow fadeInRight" data-wow-delay=".5s">
                <img src="assets/images/banner/shape/02.png" alt="rajibraj">
            </div>
            <div class="shape__item wow fadeInLeft" data-wow-delay=".5s">
                <img src="assets/images/banner/shape/03.png" alt="rajibraj">
            </div>
            <div class="shape__item wow fadeInUp" data-wow-delay=".5s">
                <img src="assets/images/banner/shape/04.png" alt="rajibraj">
            </div>
        </div>
        <div class="container">
                ...
                <div class="row align-items-center g-4">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="banner__thumb wow fadeInUp" data-wow-delay=".7s">
                            <img src="assets/images/banner/01.png" alt="rajibraj">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="feature__area wow fadeInUp" data-wow-delay=".5s">
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="feature__item">
                            <div class="feature__thumb">
                                <img src="assets/images/feature/01.png" alt="rajibraj">
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="feature__item">
                            <div class="feature__thumb">
                                <img src="assets/images/feature/02.png" alt="rajibraj">
                            </div>
                            <div class="feature__content">
                                <h5>No Fragrances</h5>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="feature__item">
                            <div class="feature__thumb">
                                <img src="assets/images/feature/03.png" alt="rajibraj">
                            </div>
                            <div class="feature__content">
                                <h5>Paraben Free</h5>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="feature__item">
                            <div class="feature__thumb">
                                <img src="assets/images/feature/04.png" alt="rajibraj">
                            </div>
                            <div class="feature__content">
    ...
    <div class="about about--one bg-img" style="background-image: url(assets/images/bg/01.jpg);">
        <div class="container">
            <div class="row g-5 justify-content-center align-items-center">
                ...
                <div class="col-lg-6 col-12">
                    <div class="about__thumb text-center text-lg-end wow fadeInUp" data-wow-delay=".5s">
                        <img src="assets/images/about/01.png" alt="rajibraj">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-4">
                        ...
                        <ul>
                            <li class=" wow fadeInLeft" data-wow-delay=".5s">
                                <div class="care__icon">
                                    <img src="assets/images/care/icon/01.png" alt="rajibraj">
                                </div>
                            ...
                            <li class=" wow fadeInLeft" data-wow-delay=".6s">
                                <div class="care__icon">
                                    <img src="assets/images/care/icon/02.png" alt="rajibraj">
                                </div>
                                <div class="care__content">
                            ...
                            <li class=" wow fadeInLeft" data-wow-delay=".7s">
                                <div class="care__icon">
                                    <img src="assets/images/care/icon/03.png" alt="rajibraj">
                                </div>
                                <div class="care__content">
                    ...
                    <div class="col-xl-4 d-none d-xl-block">
                        <div class="care__thumb text-center wow fadeInUp" data-wow-delay=".5s">
                            <img src="assets/images/care/01.png" alt="rajibraj">
                        </div>
                    </div>
                    <div class="col-xl-4 col-sm-6 col-12">
                        <ul>
                            <li class=" wow fadeInRight" data-wow-delay=".5s">
                                <div class="care__icon">
                                    <img src="assets/images/care/icon/04.png" alt="rajibraj">
                                </div>
                                <div class="care__content">
                            ...
                            <li class=" wow fadeInRight" data-wow-delay=".6s">
                                <div class="care__icon">
                                    <img src="assets/images/care/icon/05.png" alt="rajibraj">
                                </div>
                                <div class="care__content">
                            ...
                            <li class=" wow fadeInRight" data-wow-delay=".7s">
                                <div class="care__icon">
                                    <img src="assets/images/care/icon/06.png" alt="rajibraj">
                                </div>
                                <div class="care__content">
                                    <h5>Real Results</h5>
                                    <p>Conveniently and proacveu nique and ideasy use producton.</p>
    ...
    <div class="htu padding-tb bg-img" style="background-image: url(assets/images/bg/02.jpg);" id="htu">
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-6 col-12 offset-lg-6">
                    ...
                    <div class="htu__lists">
                        <ul>
                            <li class=" wow fadeInLeft" data-wow-delay=".5s">
                                <div class="htu__icon">
                                    <img src="assets/images/htu/icon/01.png" alt="rajibraj">
                                </div>
                            ...
                            <li class=" wow fadeInLeft" data-wow-delay=".6s">
                                <div class="htu__icon">
                                    <img src="assets/images/htu/icon/02.png" alt="rajibraj">
                                </div>
                                <div class="htu__content">
                            ...
                            <li class=" wow fadeInLeft" data-wow-delay=".7s">
                                <div class="htu__icon">
                                    <img src="assets/images/htu/icon/03.png" alt="rajibraj">
                                </div>
                                <div class="htu__content">
            ...
            <div class="section__wrapper">
                <div class="row g-4 justify-content-center">
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".5s">
                        <div class="product__item">
                            <div class="product__thumb">
                                <a href="shop-single.html"><img src="assets/images/product/01.png" alt="rajibraj"></a>
                            </div>
                            <div class="product__content">
                                ...
                                <h5><a href="shop-single.html">Ladies Shampoo</a></h5>
                                <span class="product__price">$257.35</span>
                                <a href="cart.html" class="lab-btn bg-transparate">Add to cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".6s">
                        <div class="product__item">
                            <div class="product__thumb">
                                <a href="shop-single.html"><img src="assets/images/product/02.png" alt="rajibraj"></a>
                            </div>
                            <div class="product__content">
                                <div class="product__rating">
                                    <ul>
                                ...
                                <h5><a href="shop-single.html">Himalaya body Lotion</a></h5>
                                <span class="product__price">$257.35</span>
                                <a href="cart.html" class="lab-btn bg-transparate">Add to cart</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".6s">
                        <div class="product__item">
                            <div class="product__thumb">
                                <a href="shop-single.html"><img src="assets/images/product/03.png" alt="rajibraj"></a>
                            </div>
                            <div class="product__content">
                                <div class="product__rating">
                                    <ul>
                                ...
                                <h5><a href="shop-single.html">Olay Blody Lotion</a></h5>
                                <span class="product__price">$257.35</span>
                                <a href="cart.html" class="lab-btn bg-transparate">Add to cart</a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6 col-12 wow fadeInUp" data-wow-delay=".8s">
                        <div class="product__item">
                            <div class="product__thumb">
                                <a href="shop-single.html"><img src="assets/images/product/04.png" alt="rajibraj"></a>
                            </div>
                            <div class="product__content">
                                <div class="product__rating">
                                    <ul>
                                ...
                                <h5><a href="shop-single.html">Boro Plus Lotion</a></h5>
                                <span class="product__price">$257.35</span>
                                <a href="cart.html" class="lab-btn bg-transparate">Add to cart</a>
                            </div>
                        </div>
    ...
    <div class="testimonial testimonial--one padding-tb bg-img" style="background-image: url(assets/images/bg/01.jpg);" id="review">
        <div class="container">
            <div class="section__header text-center wow fadeInUp" data-wow-delay=".5s">
                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="testimonial__item">
                                <div class="testimonial__inner">
                                    <div class="testimonial__thumb">
                                        <img src="assets/images/testimonial/01.jpg" alt="rajib raj">
                                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial__item">
                                <div class="testimonial__inner">
                                    <div class="testimonial__thumb">
                                        <img src="assets/images/testimonial/02.jpg" alt="rajib raj">
                                    </div>
                                    <div class="testimonial__content">
    ...
    <div class="newsletter newsletter--one padding-tb bg-img" style="background-image: url(assets/images/bg/06.jpg);">
        <div class="container">
